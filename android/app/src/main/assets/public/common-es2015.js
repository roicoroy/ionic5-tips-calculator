...
let AuthService = class AuthService {
    ...
    loginStrapiUser(loginForm) {
        ...
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].api_url + src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].login, JSON.stringify(body), { headers: this.headers });
    }
    logout() {
