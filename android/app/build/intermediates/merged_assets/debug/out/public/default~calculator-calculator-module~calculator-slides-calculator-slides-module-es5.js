  ...
  function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DatasService = class DatasService {
      ...
      postDate(dateForm) {
        ...
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].set_dates, JSON.stringify(date), {
          headers: this.headers_json
        });
      }

      getPoints() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].puntuactions, {
          headers: this.headers_json
        });
      }
...
//# sourceMappingURL=default~calculator-calculator-module~calculator-slides-calculator-slides-module-es5.js.map